...
<body>
	...
	my ($ahome, $aoverview, $adesign, $aaccounts, $asettings, $atktform, $aabout);
	...
	if ( $username ne 'Guest' ) {
		...
		<ul class="topnavbar">
			...
			# $header .= qq~<li class="topnavbar"><img src="themes/$theme/images/AutoBot32px.png" style="height: 18px; padding-top: 9px" align="left"><a href="index.cgi?mod=design" class="$adesign">$MSG{AutoBot_Design}</a></li>~;
			# $header .= qq~<li class="topnavbar"><img src="themes/$theme/images/ticket-32x32.png" style="height: 18px; padding-top: 9px" align="left"><a href="index.cgi?mod=tickets_form" class="$atktform">$MSG{Ticket_Form}</a></li>~;
			# $header .= qq~<li class="topnavbar"><img src="themes/$theme/images/system-users-32x32.png" style="height: 18px; padding-top: 9px" align="left"><a href="index.cgi?mod=accounts" class="$aaccounts">$MSG{Accounts}</a></li>~;
